...
public class BinarySearchTreeTester {
    ...
    public static void task1(){
        ...
        //The first test case is already written for you so, don't change it
        String t1 = "Task#1 Test#1";
        System.out.println(":Expected Output: LCA(6,12)=10");
        Integer out1 = Task1.lowestCommonAncestor(root,6,12);
        System.out.println(":  Your Output  : LCA(6,12)="+out1);
        if(out1==null || out1!=10) failedPrint(t1);
        ...
        Integer out2 = Task1.lowestCommonAncestor(root,20,15);
